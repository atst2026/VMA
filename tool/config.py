...
DISTRESS_SIGNALS = [
    ...
    (r"\b(?:cut|cuts|cutting|lowers?|lowered)\b.{0,30}\b(?:full[- ]year|FY|annual)\b.{0,30}\bguidance\b",
                                                     "guidance_cut",         0.9),
    ...
    (r"\b(?:trading update|trading statement)\b.{0,40}\b(?:below|behind|short)\b",
                                                     "guidance_cut",         0.7),
    # Ratings
    (r"\b(?:Moody'?s|S&P|Fitch)\b.{0,40}\b(?:downgrade|downgrades|downgraded|lowers?|cut)\b",
                                                     "ratings",              0.9),
    ...
    (r"\b(?:requisitions?|calls? for) (?:an? )?(?:EGM|extraordinary general meeting)\b",
                                                     "activist",             0.8),
    # Regulatory probes
    (r"\b(?:FCA|PRA|Ofcom|Ofgem|Ofwat|CMA|SFO|ICO) (?:investigation|probe|inquiry|review)\b",
