...
_COMPANIES: tuple[Company, ...] = (
    ...
    # grocery, high-street & specialist retail — the BD-Calendar "grocery &
    # high-street retail" cohort (tool/peers.py). These are pitched together in
    # the calendar, so each needs a verified identity or the pack fails.
    Company("currys", "Currys", "currys.co.uk",
            aliases=("currys plc", "currys pc world", "dixons carphone", "currys group")),
    Company("asda", "Asda", "asda.com", aliases=("asda group", "asda stores")),
    Company("morrisons", "Morrisons", "morrisons.com",
            aliases=("morrisons supermarkets", "wm morrison supermarkets", "wm morrison")),
    Company("cooperativegroup", "Co-operative Group", "coop.co.uk",
            aliases=("co-op", "coop", "the co-operative group", "co operative group")),
    Company("waitrose", "Waitrose", "waitrose.com",
            aliases=("waitrose & partners", "waitrose and partners")),
    Company("iceland", "Iceland Foods", "iceland.co.uk", aliases=("iceland",)),
    Company("boots", "Boots", "boots.com", aliases=("boots uk", "the boots company")),
    Company("whsmith", "WH Smith", "whsmith.co.uk",
            aliases=("w h smith", "wh smith plc")),
    Company("bandq", "B&Q", "diy.com", aliases=("b and q",)),
    Company("halfords", "Halfords", "halfords.com", aliases=("halfords group",)),
    Company("wickes", "Wickes", "wickes.co.uk", aliases=("wickes group",)),
    Company("petsathome", "Pets at Home", "petsathome.com",
            aliases=("pets at home group", "pets at home plc")),
    Company("dunelm", "Dunelm", "dunelm.com", aliases=("dunelm group", "dunelm mill")),
    Company("frasersgroup", "Frasers Group", "frasers.group",
            aliases=("frasers", "sports direct", "sports direct international")),
    Company("jdsports", "JD Sports", "jdsports.co.uk", aliases=("jd sports fashion",)),
    Company("cardfactory", "Card Factory", "cardfactory.co.uk",
            aliases=("card factory plc",)),
    # ---- Financial services -------------------------------------------
