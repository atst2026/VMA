...
<head>
  ...
  <style>
    :root {
      --navy: #0E2845;          /* VMA primary navy */
      --navy-deep: #091E36;
      --teal: #5BA6AD;          /* VMA accent teal */
      --teal-dark: #458C92;
      --teal-soft: #C7DCDF;
      --bg: #FFFFFF;
      --surface: #F5F8FA;       /* subtle off-white card surface */
      --border: #E2E8EE;        /* inner row separators (light) */
      --border-strong: #0E2845; /* panel outlines (navy — visible card boundaries) */
      --text: #0E2845;          /* navy as primary body colour, VMA-style */
      --muted: #5A6478;
      --shadow: 0 4px 14px rgba(14, 40, 69, 0.08);
      --shadow-hover: 0 8px 24px rgba(14, 40, 69, 0.12);
    }
    * { box-sizing: border-box; }
    body {
      font-family: "Mulish", -apple-system, BlinkMacSystemFont, "Segoe UI", Inter, Roboto, sans-serif;
      background: var(--bg);
      color: var(--text);
      margin: 0;
      padding: 0;
    ...
    /* HEADER — navy, VMA-style wordmark */
    .header {
      ...
      border-bottom: 1px solid rgba(91, 166, 173, 0.25);
    }
    ...
    .wordmark .vma { font-weight: 700; letter-spacing: 0.02em; }
    .wordmark .group {
      font-weight: 300;
      margin-left: 5px;
      opacity: 0.92;
    ...
    .header .meta .last::before {
      ...
      background: var(--teal);
      border-radius: 50%;
      box-shadow: 0 0 0 0 rgba(91, 166, 173, 0.6);
      animation: pulse 2s infinite;
    }
    @keyframes pulse {
      0% { box-shadow: 0 0 0 0 rgba(91, 166, 173, 0.5); }
      70% { box-shadow: 0 0 0 6px rgba(91, 166, 173, 0); }
      100% { box-shadow: 0 0 0 0 rgba(91, 166, 173, 0); }
    }
    .header .meta button {
      background: transparent;
      color: white;
      border: 1px solid rgba(91, 166, 173, 0.5);
      padding: 6px 12px;
      border-radius: 4px;
      font-size: 11px;
      font-family: inherit;
    ...
    .header .meta button:hover {
      background: rgba(91, 166, 173, 0.15);
    ...
    /* PANEL — white card with bold navy outline */
    .panel {
      background: var(--bg);
      border-radius: 6px;
    ...
    /* ITEMS — clean rows, navy text, teal accents */
    .item {
      padding: 10px 16px;
    ...
    .item .title a { color: var(--navy); text-decoration: none; border-bottom: 1px solid transparent; transition: border-color 0.15s; }
    ...
    .stack-label.stacked { background: var(--teal); color: white; }
    .stack-label.single { background: var(--surface); color: var(--teal-dark); border: 1px solid var(--teal-soft); }
    .predictor .evidence {
      font-size: 11.5px;
      color: var(--muted);
      margin-top: 5px;
    ...
    .show-more:hover { background: #ECF1F4; }
    ...
    /* ACTIONS — three cards with teal CTAs */
    .actions {
      display: grid;
    ...
    .action-card { padding: 16px 18px 18px 18px; }
    .action-card h3 {
      margin: 0 0 4px 0;
      font-size: 14px;
      font-weight: 600;
    ...
    .action-card input::placeholder { color: #9AA4B3; font-weight: 300; }
    .action-card input:focus, .action-card select:focus {
      outline: none;
      border-color: var(--teal);
      box-shadow: 0 0 0 3px rgba(91, 166, 173, 0.15);
    }
    .action-card button {
      width: 100%;
      margin-top: 14px;
    ...
    .action-card button:hover { background: var(--teal-dark); }
    ...
    .action-card .status.ok {
      background: rgba(91, 166, 173, 0.12);
      color: var(--teal-dark);
